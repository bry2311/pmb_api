...
Route::get("soalIsians/getAllSoalIsianByIdCT/{id}", 'SoalIsianController@getAllSoalIsianByIdCT');
Route::get("soalPgs/getAllSoalPgsByIdCT/{id}", 'SoalPgController@getAllSoalPgByIdCts');
